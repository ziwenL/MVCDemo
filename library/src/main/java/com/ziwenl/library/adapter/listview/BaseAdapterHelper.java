...
public class BaseAdapterHelper {
    ...
    /**
     * Package private field to retain the associated user data and detect a change
     */
     ...
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper loadImage(int viewId, String url) {
        try {
     ...
     * @return
     */
    public BaseAdapterHelper setImage(int viewId, String url) {
        ImageView view = retrieveView(viewId);
        GlideUtil.loadPicture(url, view);
        return this;
    }
     ...
     * @return
     */
    public BaseAdapterHelper setAvatar(int viewId, String url) {
        ImageView view = retrieveView(viewId);
        GlideUtil.loadAvatarPicture(url, view);
        return this;
    }
...
//    }
    ...
    /**
     * Retrieves the last converted data on this view.
     */
